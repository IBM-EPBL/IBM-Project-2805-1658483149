...
app.config['MAIL_USERNAME'] = 'akashbalu004@gmail.com'
app.config['MAIL_PASSWORD'] = 'llqcktexppjtazgp'
app.config['MAIL_USE_TLS'] = False
app.config['MAIL_USE_SSL'] = True
   
# message object mapped to a particular URL ‘/’
query="SELECT * FROM APPLIEDUSERS"
@app.route('/sendmail')
def sendmail():
   msg = Message('Hello',sender ='akashbalu004@gmail.com',recipients = ['akashbalu16@gmail.com']) 
   msg.body = print(query);
   mail.send(msg)
